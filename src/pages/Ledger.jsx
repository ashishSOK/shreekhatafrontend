...
const Ledger = () => {
    ...
    if (loading) {
        return <PageLoader message="Loading Ledger..." />;
    }

    return (
        <Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: { xs: 2.5, sm: 3 }, px: { xs: 0.5, sm: 0 } }}>
                <Typography
                    variant="h4"
                    sx={{
                        fontWeight: 800,
                        fontSize: { xs: '1.75rem', sm: '2rem', md: '2.125rem' },
                        background: isDark ? 'linear-gradient(to right, #ffffff, #a5b4fc)' : 'linear-gradient(to right, #0f172a, #4f46e5)',
                        ...
                        InputProps={{
                            startAdornment: (
                                <InputAdornment position="start">
                                    <Search sx={{ color: 'rgba(255,255,255,0.4)', ml: 1 }} />
                                </InputAdornment>
                            ),
                        }}
                    />
            ...
            >
                ...
                >
                    ...
                    <Box sx={{ display: { xs: 'block', sm: 'none' }, p: 2 }}>
                        <AnimatePresence>
                            {transactions.map((transaction, index) => {
                                const cardColor = ['#6366f1', '#8b5cf6', '#ec4899', '#f59e0b', '#10b981', '#3b82f6', '#ef4444', '#14b8a6'][index % 8];
                                return (
                                    <motion.div
                                        layout
                                        key={transaction._id}
                                    ...
                                    >
                                        <Card
                                            sx={{
                                                ...
                                                p: 1.25,
                                                borderRadius: '16px',
                                                background: `linear-gradient(145deg, ${cardColor}${isDark ? '15' : '10'} 0%, ${isDark ? 'rgba(255,255,255,0.02)' : 'rgba(255,255,255,0.9)'} 100%)`,
                                                backdropFilter: 'blur(24px)',
                                                border: `1px solid ${cardColor}${isDark ? '25' : '40'}`,
                                                position: 'relative',
                                                overflow: 'hidden',
                                                ...
                                                '&:hover': {
                                                    ...
                                                    boxShadow: `0 8px 24px ${cardColor}${isDark ? '15' : '30'}`,
                                                }
                                            }}
                                        >
                                            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 0.75, pl: 0.5 }}>
                                                <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1 }}>
                                                    <Typography sx={{ fontWeight: 800, fontSize: '1.25rem', color: isDark ? 'white' : '#0f172a', lineHeight: 1, letterSpacing: '-0.02em' }}>
                                                        {formatCurrency(transaction.amount)}
                                                    </Typography>
                                                    <Typography sx={{ fontSize: '0.65rem', color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(0,0,0,0.6)', fontWeight: 600, letterSpacing: '0.03em', textTransform: 'uppercase' }}>
                                                ...
                                                <Chip
                                                    ...
                                                    size="small"
                                                    sx={{
                                                        background: `${getTransactionTypeColor(transaction.type)}15`,
                                                        color: getTransactionTypeColor(transaction.type),
                                                        fontWeight: 800,
                                                        fontSize: '0.6rem',
                                                        height: '20px',
                                                        px: 0.5,
                                                        border: `1px solid ${getTransactionTypeColor(transaction.type)}30`,
                                            ...
                                            <Box sx={{ pl: 0.5, mb: 1 }}>
                                                <Box sx={{ display: 'flex', flexWrap: 'wrap', columnGap: 1.5, rowGap: 0.25 }}>
                                                    <Typography sx={{ fontSize: '0.75rem', color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(0,0,0,0.6)' }}>
                                                        Cat: <strong style={{ color: isDark ? 'white' : '#0f172a' }}>{transaction.category}</strong>
                                                    </Typography>
                                                    <Typography sx={{ fontSize: '0.75rem', color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(0,0,0,0.6)' }}>
                                                        Via: <strong style={{ color: isDark ? 'white' : '#0f172a', textTransform: 'capitalize' }}>{transaction.paymentMode}</strong>
                                                    </Typography>
                                                    {transaction.vendor && (
                                                        <Typography sx={{ fontSize: '0.75rem', color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(0,0,0,0.6)' }}>
                                                            To: <strong style={{ color: isDark ? 'white' : '#0f172a' }}>{transaction.vendor}</strong>
                                                        </Typography>
                                                    )}
                                                    {transaction.addedBy && (
                                                        <Typography sx={{ fontSize: '0.75rem', color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(0,0,0,0.6)' }}>
                                                            By: <strong style={{ color: '#6366f1' }}>{transaction.addedBy.name || 'Owner'}</strong>
                                                        </Typography>
                                                    )}
                                                </Box>
                                                <Typography sx={{ fontSize: '0.75rem', color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(0,0,0,0.6)', mt: 0.25, display: '-webkit-box', WebkitLineClamp: 1, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
                                                    Note: <strong style={{ color: isDark ? 'white' : '#0f172a', fontWeight: 800 }}>{transaction.notes || '-'}</strong>
                                                </Typography>
                                            </Box>

                                            <Box sx={{ display: 'flex', gap: 1, justifyContent: 'space-between', pt: 0.75, borderTop: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(0,0,0,0.08)' }}>
                                                <Button
                                                    variant="contained"
                                                    size="small"
                                                    onClick={() => handleViewReceipts(transaction._id)}
                                                    ...
                                                    sx={{
                                                        ...
                                                        fontWeight: 600,
                                                        borderRadius: 2,
                                                        '&:hover': { background: 'rgba(96, 165, 250, 0.2)', boxShadow: 'none' }
                                                    }}>
                                                    View Receipt
                                                </Button>
                                                <Stack direction="row" spacing={1}>
                                                    <IconButton size="small" onClick={() => handleOpenDialog(transaction)} sx={{ borderRadius: 2, background: 'rgba(167, 139, 250, 0.1)', color: '#a78bfa', '&:hover': { background: 'rgba(167, 139, 250, 0.2)' } }}>
                                                        <Edit fontSize="small" />
                                                    </IconButton>
                                                    <IconButton size="small" onClick={() => handleDelete(transaction._id)} sx={{ borderRadius: 2, background: 'rgba(248, 113, 113, 0.1)', color: '#f87171', '&:hover': { background: 'rgba(248, 113, 113, 0.2)' } }}>
                                                        <Delete fontSize="small" />
                                                    </IconButton>
                                                </Stack>
                                            </Box>
            ...
            >
                ...
                <DialogContent sx={{ pb: isMobile ? 12 : 3, pt: 3, px: { xs: 2, md: 3 } }}>
                    <Grid container spacing={2} sx={{ mt: 1 }}>
                        ...
                        {/* Bill Upload */}
                        <Grid item xs={12}>
                            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.45, duration: 0.4 }}>
                                <Button
                                    variant="outlined"
                                    component="label"
                ...
                <DialogActions sx={{ p: 2, gap: 1 }}>
                    <motion.div
                        ...
                        style={{ display: 'flex', width: '100%', justifyContent: 'flex-end', gap: '8px' }}
                    >
                        <Button
                            onClick={handleCloseDialog}
